...
namespace SupperMarketSaiGon.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            IsActive.Add(new SelectListItem() { Text = "Đang hoạt động", Value = "true" });
            IsActive.Add(new SelectListItem() { Text = "Ngưng hoạt động", Value = "false" });
            ViewData["TrangThai"] = IsActive;
